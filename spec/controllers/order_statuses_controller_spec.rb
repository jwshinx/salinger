  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved order_status as @order_status" do
        ...
        post :create, {:order_status => { "title" => "invalid value" }}, valid_session
        assigns(:order_status).should be_a_new(OrderStatus)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order_status" do
        ...
        OrderStatus.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => order_status.to_param, :order_status => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the order_status as @order_status" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        OrderStatus.any_instance.stub(:save).and_return(false)
        put :update, {:id => order_status.to_param, :order_status => { "title" => "invalid value" }}, valid_session
        assigns(:order_status).should eq(order_status)
      end
