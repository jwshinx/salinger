  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved email as @email" do
        ...
        post :create, {:email => { "content" => "invalid value" }}, valid_session
        assigns(:email).should be_a_new(Email)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested email" do
        ...
        Email.any_instance.should_receive(:update_attributes).with({ "content" => "MyString" })
        put :update, {:id => email.to_param, :email => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the email as @email" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Email.any_instance.stub(:save).and_return(false)
        put :update, {:id => email.to_param, :email => { "content" => "invalid value" }}, valid_session
        assigns(:email).should eq(email)
      end
